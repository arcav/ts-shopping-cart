    ...
    return (
        <div className="py-8 border-b border-gray-100 last:border-0 relative">
            ...
            <div className="relative group/carousel">
                ...
                <div 
                    ref={listRef}
                    className="flex overflow-x-auto snap-x snap-mandatory scrollbar-hide pb-8 px-4 md:px-0 gap-3 md:gap-6 scroll-smooth"
                >
                    {products.map(product => (
                        <div key={product.id} className="flex-none w-[145px] xs:w-[155px] md:w-72 snap-center">
                            <Product
                                product={product}
